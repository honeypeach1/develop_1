...
(function (g) {
    ...
    m.Client.prototype = {
        ...
        positionElement: function () {
            var a = m.getDOMObjectPosition(this.domElement), b = this.div.style;
            b.position = "absolute";
            b.width = a.width + "px";
    ...
    var O = function (a, b) {
            ...
            var d = b.fieldBoundary, f = b.fieldSeparator, e = new RegExp(d, "g"),
                n = b.escapeChar !== z ? b.escapeChar : "\\", l = function (u) {
    ...
    w.ext.buttons.excelFlash = g.extend({}, I, {
        className: "buttons-excel buttons-flash", text: function (a) {
            ...
            this.processing(!0);
            a = d._flash;
            var f = 0, e = g.parseXML(A["xl/worksheets/sheet1.xml"]), n = e.getElementsByTagName("sheetData")[0];
            c = {
            ...
            var l = b.buttons.exportData(d.exportOptions), E, C, p = function (h) {
                ...
                for (var k = 0, F = h.length; k < F; k++) {
                    var K = M(k) + "" + E, y = null;
                    if (null === h[k] || h[k] === z || "" === h[k]) if (!0 === d.createEmptyCells) h[k] = ""; else continue;
